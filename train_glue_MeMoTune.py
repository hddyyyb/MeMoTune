...
def main():
    args = parse_args()
    import utils_MeMoTune
    utils_MeMoTune.MeMoTune_scale = args.scale
    utils_MeMoTune.MeMoTune_K = args.K
    logging.basicConfig(
    ...
    utils_MeMoTune.replace_module(model,
    ...
    utils_MeMoTune.show_model_stats(model, mark_only_lora_as_trainable=True)
