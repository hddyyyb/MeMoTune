...
class BaseTuner(nn.Module, ABC):
    ...
    def __init__(self, model, peft_config: Union[PeftConfig, dict[str, PeftConfig]], adapter_name: str) -> None:
        ...
        if not hasattr(self, "peft_config"):
            ...
            print(f'Already found a `peft_config` attribute in the model. This will lead to having multiple adapters')
        ...
        self._pre_injection_hook(self.model, self.peft_config[adapter_name], adapter_name)  # what does it do?
        self.inject_adapter(self.model, adapter_name)  # for each layer
...
class BaseTunerLayer(ABC):
    ...
    def set_adapter(self, adapter_names: str | list[str]) -> None:
        ...
        for layer_name in self.adapter_layer_names:
            # self.adapter_layer_names:('lora_A', 'lora_B', 'lora_embedding_A', 'lora_embedding_B')
